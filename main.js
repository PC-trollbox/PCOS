    ...
    bootInt = setTimeout(function() {
        try {
            ...
            ChangeCID = function(cid) {
                ...
                alertbug({
                    stack: "Changed successfully. If you see an already taken window. Please say me."
                });
            ...
            function antivirus() {
                setTimeout(function() {
                    ...
                    execute = function(app) {
                        if (app == "antivirus")
                            return alertbug({
                                stack: "Access is denied: You already have an antivirus."
                            })
                        if (mem == 0)
                            return alertbug({
                                stack: "No free memory. Please wait and try again."
                        ...
                        if (virusKit.includes(app)) {
                            ...
                            alertbug({
                                stack: "<BR>Virus detected!<br>Trojan/" + virusKit[virusKit.indexOf(app)] + "<br>"
                            })
                    ...
                    new uinotif({
                        nme: "AVenable" + Math.random().toString(),
                        content: "<h1>Virus protection enabled!</h1>",
            ...
            osevents = {
                ...
                on: function(event, callback) {
                    ...
                    if (typeof event !== "string" && typeof callback !== "function")
                        return "Cannot handle the event callback for the event '" + event + "'."
                ...
                emit: function(event, args) {
                    ...
                    if (typeof event !== "string" || args === undefined)
                        return "Cannot emit the event '" + event + "'."
            ...
            sys32 = {
                desktop: {
                    ...
                    SwitchToSecureDesktop: function() {
                        if (this.BackupDesktop != undefined)
                            return "no";
                ...
                users: {
                    logout: function() {
                        if (!confirm("Do you want to log out from the system?"))
            ...
            uiwindow = class uiwindow {
                ...
                constructor(settings) {
                    ...
                    if (typeof settings !== "object")
                        throw new Error("Made settings an object.")

                    if (typeof settings.nme !== "string")
                        throw new Error("Make name a string.")

                    if (typeof settings.title !== "string")
                        throw new Error("Make title a string.")

                    if (typeof settings.content !== "string")
                        throw new Error("Make content a string.")
                    if (document.getElementById(settings.nme) != null)
                        return alertbug({
                    ...
                    $("#" + settings.nme).dialog({
                        ...
                        close: function(event, ui) {
                            ...
                            if (typeof settings.closefunc == "function")
                                return settings.closefunc(event, ui);
                            return true;
                        },
                        beforeClose: function(event, ui) {
                            if (typeof settings.beforeclosefunc == "function")
                ...
                sit.on("errorGetting", function(errorid) {
                    if (errorid == "00278") {
                        ...
                        new uiwindow({
                            nme: "note-win-comp",
                            title: "ComputerID",
                            content: 'Your ComputerID is already taken.<br>Please set other ComputerID and press button OK.<br><button onclick=ChangeCID(ComputerID)'
                        })
                        execute("ComputerID")
                    }
                })
