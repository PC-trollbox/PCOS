...
if (localStorage.getItem("oobe") == null && apps !== defaultapps){
		document.body.style= "background-color: #0078D7; color: white;"
		document.body.innerHTML = `	   <centeralize><img src="https://i.imgur.com/Hco0aDe.gif" heigth=100 width=100></img><br>Please wait...</centeralize>`
		setTimeout(function(){
			document.body.innerHTML = `	   <centeralize><h1>Use the new PCOS version! <button onclick=continues()>X</button></h1><br><b>Got the apps updated quickly.</b><br><button onclick=startUpd()>Start Updating</button><br><em>Note: This will clear all your non-default apps.</em></centeralize>`
			continues = function(){
				continues = null;
				startUpd = null;
				 document.body.innerHTML = '<div id="desktop"><label onclick="new uiwindow({nme: \'PCchat\', title: \'PCchat iframe\', content: opened})"><figure class="sign"><p><img src="https://repl.it/public/images/favicon.ico" alt="Repl.IT favicon" width=100 height=100></img></p><figcaption>PCchat</figcaption></figure></label><label onclick="new uiwindow({nme: \'browserinfo\', title: \'Browser information\', content: searchedProps})"><figure class="sign"><p><img src="https://www.iconarchive.com/download/i47362/icons-land/vista-hardware-devices/Computer.ico" alt="My computer icon from IconArchive" width=100 height=100></img></p><figcaption>Browser information</figcaption></figure></label></div><div id="min" class="footer"><label id="menuhandler"></label><br><button type="button" class="btn btn-secondary" id=startyemenu>PC</button></div>'
 ...
 <centeralize> <strong>PC laptop</strong></centeralize><footcen><img src="https://i.imgur.com/Hco0aDe.gif" heigth=100 width=100></img><br>Performing Firmware Update...<br>Powered by <strong>PCOS</strong></footcen>
`
				setTimeout(function(){
					localStorage.removeItem("apps")
				localStorage.setItem("oobe", "true");
					location.reload()
				}, 60000);
