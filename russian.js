...
osevents.emit("RC", {js: js, caller: callerrw})
	...
	setInterval(function(){
		    searchedProps = "UserAgent: " + navigator.userAgent + "<br>Браузер: " + BrowserDetect.browser + " "+ BrowserDetect.version + "<br>OS: " + BrowserDetect.OS + "<br>Ваш ComputerID для удаленного управления: " + sit.id
	})
